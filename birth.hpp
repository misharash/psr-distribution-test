...
std::tuple<double, double> birth_init(CITable&, CITable&);

void birth_all(std::vector<Pulsar>&, CITable const&, CITable const&, double, std::uniform_real_distribution<>&, std::mt19937&);
